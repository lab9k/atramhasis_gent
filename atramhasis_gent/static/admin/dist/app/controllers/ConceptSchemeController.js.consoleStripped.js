 ...
 */
define("app/controllers/ConceptSchemeController", [
  'dojo/_base/declare',
  'dojo/_base/lang',
  'dojo/_base/array',
  'dojo/request/xhr',
  ...
  return declare( null, {
    ...
    constructor: function(args) {
       0 && console.debug('ConceptSchemeController::constructor');
      declare.safeMixin(this, args);
      this.conceptSchemeList = [];
    },

    getConceptSchemes: function(){
       0 && console.debug('ConceptSchemeController::getConceptSchemes');
    ...
    getConceptScheme: function(id) {
       0 && console.debug('ConceptSchemeController::getConceptScheme', id);
    ...
    editConceptScheme: function(concept){
       0 && console.debug('ConceptSchemeController::editConceptScheme', concept);
    ...
    loadConceptSchemeStores: function() {
       0 && console.debug('ConceptSchemeController::loadConceptSchemeStores');
