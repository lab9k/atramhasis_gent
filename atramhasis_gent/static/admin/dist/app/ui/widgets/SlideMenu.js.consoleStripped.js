require({cache:{
'url:app/ui/widgets/templates/SlideMenu.html':"<div class=\"slidemenu-container slidemenu-close\" data-dojo-attach-point=\"menuContainer\" data-dojo-attach-event=\"onClick: _slideOpen\">\n  <div class=\"slidemenu-inner\">\n    <div data-dojo-attach-point=\"menuNode\"></div>\n  </div>\n</div>\n"}});
define("app/ui/widgets/SlideMenu", [
  'dojo/_base/declare',
  'dojo/_base/lang',
  'dojo/dom-construct',
  'dojo/dom-class',
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    postCreate: function () {
      this.inherited(arguments);
       0 && console.debug('SlideLegend::postCreate');
     ...
     */
    startup: function () {
       0 && console.debug('SlideLegend::startup');
      this.inherited(arguments);
    },
