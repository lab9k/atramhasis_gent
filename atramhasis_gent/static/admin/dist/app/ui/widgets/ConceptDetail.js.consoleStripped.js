require({cache:{
'url:app/ui/widgets/templates/ConceptDetail.html':"<div data-dojo-attach-point=\"conceptDetailNode\">\n  <div class=\"large-12 columns\" style=\"margin-top: 20px; padding-bottom: 20px;\">\n    <div class=\"large-8 columns\">\n      <h1 data-dojo-attach-point=\"conceptTitleViewNode\"></h1>\n      <span class=\"concept-title-info\" data-dojo-attach-point=\"idViewNode\"></span>\n      <span class=\"concept-title-info\" data-dojo-attach-point=\"typeViewNode\"></span>\n      <span class=\"concept-title-info\" data-dojo-attach-point=\"uriViewNode\"></span>\n    </div>\n    <div class=\"large-4 columns\">\n      <a href=\"#\" class=\"button tiny right\" data-dojo-attach-event=\"onClick: _deleteConcept\">DELETE</a>\n      <a href=\"#\" class=\"button tiny right\" style=\"margin-right: 10px;\" data-dojo-attach-event=\"onClick: _openEditDialog\">EDIT</a>\n      <button href=\"#\" class=\"button tiny right\" style=\"margin-right: 10px;\" data-dojo-attach-event=\"onClick: _openMergeDialog\"\n         data-dojo-attach-point=\"mergeButton\">MERGE</button>\n    </div>\n  </div>\n  <hr class=\"concept-hr\">\n  <div class=\"large-12 columns label-relation-block\">\n    <div class=\"large-6 columns\">\n      <h4 class=\"no-top-padding\">Labels</h4>\n      <dl class=\"dllist\">\n        <dt>Preferred labels</dt><dd data-dojo-attach-point=\"preferredLabelsNode\"></dd>\n        <dt>Alternate labels</dt><dd data-dojo-attach-point=\"alternateLabelsNode\"></dd>\n        <dt>Hidden labels</dt><dd data-dojo-attach-point=\"hiddenLabelsNode\"></dd>\n        <dt>Sort labels</dt><dd data-dojo-attach-point=\"sortLabelsNode\"></dd>\n      </dl>\n    </div>\n    <div class=\"large-6 columns\">\n      <h4 class=\"no-top-padding\">Relations</h4>\n      <dl class=\"dllist\" data-dojo-attach-point=\"relationsListNode\">\n      </dl>\n      <h4 class=\"no-top-padding\">Matches</h4>\n      <dl class=\"dllist\" data-dojo-attach-point=\"matchesListNode\">\n      </dl>\n    </div>\n  </div>\n  <hr class=\"concept-hr\">\n  <div class=\"large-12 columns\">\n    <div class=\"large-12 columns\">\n      <ul class=\"scopeNote\" data-dojo-attach-point=\"scopeNoteNode\">\n        <h3>notes</h3>\n      </ul>\n    </div>\n    <div class=\"large-12 columns\">\n      <ul class=\"scopeNote\" data-dojo-attach-point=\"sourcesNode\">\n        <h3>sources</h3>\n      </ul>\n    </div>\n  </div>\n</div>"}});
define("app/ui/widgets/ConceptDetail", [
  'dojo/_base/declare',
  'dojo/_base/array',
  'dojo/_base/lang',
  'dojo/promise/all',
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    postCreate: function () {
      this.inherited(arguments);
       0 && console.debug('ConceptDetail::postCreate');
      domAttr.set(this.mergeButton, 'disabled', true);
    },

    startup: function () {
      this.inherited(arguments);
       0 && console.debug('ConceptDetail::startup');

      this._setData(this.concept);
    },

    _openEditDialog: function (evt) {
       0 && console.debug('ConceptDetail::_openEditDialog');
    ...
    _openMergeDialog: function(evt) {
       0 && console.debug('ConceptDetail::_openMergeDialog');
      evt ? evt.preventDefault() : null;
    ...
    _deleteConcept: function(evt) {
       0 && console.debug('ConceptDetail::_deleteConcept');
      evt ? evt.preventDefault() : null;
