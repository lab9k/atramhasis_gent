require({cache:{
'url:app/utils/templates/HtmlEditor.html':"<div class=\"htmlEditor\">\n    <div data-dojo-attach-point=\"containerToolbarNode\" ></div>\n    <textarea data-dojo-attach-point=\"containerTextAreaNode\"></textarea>\n</div>"}});
define("app/utils/HtmlEditor", [
  'dojo/_base/declare',
  'dojo/_base/array',
  'dojo/_base/lang',
  ...
  return declare([_WidgetBase, TemplatedMixin], {
    ...
    _btnAction: function (btn) {
       0 && console.debug('HtmlEditor::_btnAction', btn);
