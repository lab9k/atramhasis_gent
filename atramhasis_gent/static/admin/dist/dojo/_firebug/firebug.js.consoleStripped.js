define("dojo/_firebug/firebug", [
	...
	//	|	 0 && console.log("my object", {foo:"bar"})
	// example:
	...
	window.console = {
		...
		time: function(name){
			...
			// example:
			//	|	 0 && console.time("load");
			//	|	 0 && console.time("myFunction");
			//	|	 0 && console.timeEnd("load");
			//	|	 0 && console.timeEnd("myFunction");
		...
		trace: function(_value){
			...
			var f = console.trace.caller; //function that called trace
			 0 && console.log(">>>  0 && console.trace(stack)");
			for(var i=0;i<stackAmt;i++){
				...
				if(f.arguments.length){
					 0 && console.dir({"function":func, "arguments":args});
				}else{
					 0 && console.dir({"function":func});
				}
	...
	function evalCommandLine(){
		...
		try{
			value = eval(text);
			 ...
			 0 && console.debug(e); // put exception on the console
		}
