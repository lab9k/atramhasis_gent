define("dGrowl/main", [ "dojo/text", "dojo/_base/declare", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/topic", "dojo/dom-construct", "dGrowl/NotificationNode", "dojo/query", "dojo/_base/lang", "dojo/dom-class"],
		...
		'addNotification':function(m, o)
		{
			...
			if(this.chanDefs[o.channel] != undefined)
			{
				...
				return n;
				 ...
				 0 && console.error(o.channel + ' channel was not found!');
			return false;
		},
